...
function statRewardsController(app, opt) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        app.get('/total_rewards/erc20', {
            ...
            try {
                const data = req.routeConfig.jwtData;
                const deleteReward = req.query;
                const res = yield (0, rewards_1.getTotalCountErc20Reward)({ email: data === null || data === void 0 ? void 0 : data.email, phone: data === null || data === void 0 ? void 0 : data.phone, company_id: data === null || data === void 0 ? void 0 : data.company_id }, deleteReward.id);
                reply
                    .code(res.code)
                    .type('application/json; charset=utf-8')
                    .send('body' in res ? { body: res.body } : { error: res.error });
        ...
        app.get('/total_rewards/erc721', {
            ...
            try {
                const data = req.routeConfig.jwtData;
                const deleteReward = req.query;
                const res = yield (0, rewards_1.getTotalCountErc721Reward)({ email: data === null || data === void 0 ? void 0 : data.email, phone: data === null || data === void 0 ? void 0 : data.phone, company_id: data === null || data === void 0 ? void 0 : data.company_id }, deleteReward.id);
                reply
                    .code(res.code)
                    .type('application/json; charset=utf-8')
                    .send('body' in res ? { body: res.body } : { error: res.error });
        ...
        app.get('/rewarded_users/erc20', {
            ...
            try {
                const data = req.routeConfig.jwtData;
                const deleteReward = req.query;
                const res = yield (0, rewards_1.getUserCountErc20Reward)({ email: data === null || data === void 0 ? void 0 : data.email, phone: data === null || data === void 0 ? void 0 : data.phone, company_id: data === null || data === void 0 ? void 0 : data.company_id }, deleteReward.id);
                reply
                    .code(res.code)
                    .type('application/json; charset=utf-8')
                    .send('body' in res ? { body: res.body } : { error: res.error });
        ...
        app.get('/rewarded_users/erc721', {
            ...
            try {
                const data = req.routeConfig.jwtData;
                const deleteReward = req.query;
                const res = yield (0, rewards_1.getUserCountErc721Reward)({ email: data === null || data === void 0 ? void 0 : data.email, phone: data === null || data === void 0 ? void 0 : data.phone, company_id: data === null || data === void 0 ? void 0 : data.company_id }, deleteReward.id);
                reply
                    .code(res.code)
                    .type('application/json; charset=utf-8')
                    .send('body' in res ? { body: res.body } : { error: res.error });
