...
function statUsersController(app, opt) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        app.get('/users_active', {
            ...
            try {
                const data = req.routeConfig.jwtData;
                const res = yield (0, users_1.getActive)({ email: data === null || data === void 0 ? void 0 : data.email, phone: data === null || data === void 0 ? void 0 : data.phone, company_id: data === null || data === void 0 ? void 0 : data.company_id });
                reply
                    .code(res.code)
                    .type('application/json; charset=utf-8')
                    .send('body' in res ? { body: res.body } : { error: res.error });
